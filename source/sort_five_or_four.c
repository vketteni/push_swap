...
static void	pa_ra(long *stack_a, long *stack_b, int *stack_size_a,
		int *stack_size_b)
{
...
static void	one_into_three(long *stack_a, long *stack_b, int *stack_size_a,
		int *stack_size_b)
{
	...
	else if (stack_b[0] > stack_a[1] && stack_b[0] < stack_a[2])
	{
		...
		pa_ra(stack_a, stack_b, stack_size_a, stack_size_b);
}

static void	one_into_four(long *stack_a, long *stack_b, int *stack_size_a,
		int *stack_size_b)
{
	if (stack_b[0] < stack_a[0])
		push_a(stack_a, stack_b, stack_size_a, stack_size_b);
