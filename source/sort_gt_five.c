...
/*   Updated: 2024/02/01 15:06:43 by vketteni         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../push_swap.h"

void	initialize_copies(long *stack_a, int *stack_size_a, long *copy1,
		long *copy2)
{
	int	i;
...
void	transform_values_based_on_relative_order(long *stack_a,
		int *stack_size_a, long *original_copy, long *sorted_copy)
{
	int	i;
	int	j;
...
void	radix_sort(long *stack_a, long *stack_b, int *stack_size_a,
		int *stack_size_b)
{
	int	max_bits;
	int	max_number;
		...
		int *stack_size_b)
{
	...
	transform_values_based_on_relative_order(stack_a, stack_size_a,
		original_copy, sorted_copy);
	free(original_copy);
	free(sorted_copy);
